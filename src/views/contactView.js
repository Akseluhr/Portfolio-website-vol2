...
import { SERVICE_ID, TEMPLATE_ID, API_KEY } from '/Users/akseluhr/Documents/GitHub/Portfolio-website-vol2/src/apiConfig.js';
            ...
            <div className='fourthView'>
                <div className='fourthLeft'>
                    ...
                    <form ref={form} onSubmit={sendEmail}>
                        ...
                        <textarea rows='10' id='msg' name='message' placeholder='Your message..'></textarea>
                        <button type='submit' className='btn-type-one' disabled={isLoading}>Send</button> {/* disabled={isLoading} */}
                    </form>
                ...
                <div className='details'>
                    ...
                    <ul>
                        <li>
                            ...
                            {(time < 20 && time > 8) && (sky <=4) ? <span className="status">Sun! See you outdoors</span> : (time < 20 && time > 8) && (sky > 5) ? <span className="status"> Rain outdoors! Movie time</span> : <span className="status"> Sleepy Time. Good Night!</span>}
                        </li>
